...
The project was developed as part of Controls and Systems course (some developments have been made later), with an emphasis on physically realistic modeling (literature-sourced hardware parameters, a DC motor actuator model, and explicit state/input constraints) rather than a purely textbook simulation.
